...
public class PersonService {
    ...
    /**
     * Bagaimana kita membuat test untuk method get()
     * karena get membutuhkan personRepository, artinya ketergantungan terhadap interface atau class yang lain
     * untuk itu kita bisa menggunakan Mockito
     */

    /**
     * kita buat method untuk register
     */
